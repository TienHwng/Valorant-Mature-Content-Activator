...
if errorlevel 3 start "" "C:\Riot Games\VALORANT\live\ShooterGame\Content\Paks" & goto :menu
...
if exist "C:\Riot Games\VALORANT\live\ShooterGame\Content\Paks\VNGLogo-WindowsClient.*" (
...
:executer
copy /y "C:\Users\Hung\Documents\Valorant Paks Files\*.*" "C:\Riot Games\VALORANT\live\ShooterGame\Content\Paks"
del "C:\Riot Games\VALORANT\live\ShooterGame\Content\Paks\VNGLogo-WindowsClient.*"
